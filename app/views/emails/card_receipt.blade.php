...
<div id="page">
  ...
  <div id="content">
    ...
    <hr>
    <table>
      <tr><td><strong>Description</strong></td><td><strong>Qty</strong></td><td><strong>Unit Price</strong></td><td><strong>Discount</strong></td><td><strong>Amount</strong></td></tr>
      <tr class="odd"><td>Card Purchase</td><td>{{$order->cards}}</td><td>{{$card->dollar_rate}}</td><td>{{$pricing->discount}}</td><td>{{$charge->amount/100}}</td></tr>
